...
class __TwigTemplate_7e2acbebc1972fdd585d50fc2b776cc49850b37bdbf75f40360051849e5fc554 extends Twig_Template
{
    ...
    {
        // line 1
        $context["__internal_d727a19f28a0c41df21fbd070ed1063cbc359af25c63f8c9f32fd1eba36e086a"] = $this->loadTemplate("modules/agent/pages/single/macro.twig", "modules/agent/pages/single/includes/agent-info.twig", 1);
        // line 7
...
";
    ...
    {
        return new Twig_Source("{% from 'modules/agent/pages/single/macro.twig' import property_list_wrapper %}
...
{% block content %}
  <div class=\"worker worker--list worker--details js-unhide-block\">
    <div data-animate-end=\"animate-end\" class=\"worker__item vcard\">
      {{ agent_macro.photo(agent, 500, 480, false) }}
      <div class=\"worker__intro\">
        <div class=\"worker__intro-head\">
          <div class=\"worker__intro-name\">
            {{ agent_macro.name_and_title(agent) }}
          </div>
        ...
        <div class=\"worker__intro-row\">
          <div class=\"worker__intro-col\">
            {{ agent_macro.contacts(agent) }}
          </div>
          <div class=\"worker__intro-col\">
            {{ agent_macro.social(agent) }}
          </div>
        </div>
      </div>
      <div class=\"worker__descr\">{{ agent.content|raw }}</div>
      <!-- end of block .worker__descr-->
      <div class=\"clearfix\"></div>
    </div>
    <!-- end of block .worker__item-->
    ...
    {% if page.show_contact_form and page.cf7_form is not empty %}
...
{% endblock %}", "modules/agent/pages/single/includes/agent-info.twig", "/Users/xeijz23/Documents/Applications/quantum/public_html/wp-content/themes/themeforest-15965811-realtyspace-real-estate-wordpress-theme/realtyspace/views/modules/agent/pages/single/includes/agent-info.twig");
    }
}
