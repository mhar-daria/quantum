...
class __TwigTemplate_c6a322d235eb6e38b2ecf19c33fec59e8317d93b79f466e5514f7c40cd72b009 extends Twig_Template
{
    ...
    {
        // line 2
        $context["__internal_124cf4e7b8c0d39bffdc50a89a2e6e59f35749dbf7524c1b81437de40526be3b"] = $this->loadTemplate("macro.twig", "modules/other/sections/counter.twig", 2);
        // line 3
  ...
  <div class=\"achievement\">
    ...
    ";
          ...
          ";
                // line 18
                echo $context["__internal_124cf4e7b8c0d39bffdc50a89a2e6e59f35749dbf7524c1b81437de40526be3b"]->geticon(twig_escape_filter($this->env, $this->getAttribute($context["item"], "icon", array()), "html_attr"), "achievement__icon");
                echo "
          <div data-count-end=\"";
                // line 19
      ...
      ";
            ...
            if (!$context['_iterated']) {
                // line 27
                echo "        ";
                echo $context["__internal_124cf4e7b8c0d39bffdc50a89a2e6e59f35749dbf7524c1b81437de40526be3b"]->getno_items_available();
                echo "
      ";
            }
...
";
    ...
    {
        return new Twig_Source("{# @var section \\cf47\\plugin\\realtyspace\\module\\other\\section\\counter\\CounterView #}
{% from 'macro.twig' import no_items_available, icon %}
{% set module_id = js_module('achievement', {
'animate': true,
}) %}

{% extends 'section-widget.twig' %}
{% set widget_class='landing achievement' %}
...
{% block content %}
    ...
    {% else %}
      {% for item in section.items %}
        <div class=\"achievement__item\">
          {{ icon(item.icon|e('html_attr'), 'achievement__icon') }}
          <div data-count-end=\"{{ item.number }}\" data-count-duration=\"1\"
               class=\"achievement__counter achievement__counter--lg js-count-up\">
            {{ item.number }}
          </div>
          <div class=\"achievement__counter\">{{ item.number }}</div>
          <div class=\"achievement__name\">{{ item.label|raw }}</div>
        </div>
      {% else %}
        {{ no_items_available() }}
      {% endfor %}
  ...
  <!-- END SECTION ACHIEVEMENT-->
{% endblock %}", "modules/other/sections/counter.twig", "/Users/xeijz23/Documents/Applications/quantum/public_html/wp-content/plugins/cf47-realtyspace/views/modules/other/sections/counter.twig");
    }
}
