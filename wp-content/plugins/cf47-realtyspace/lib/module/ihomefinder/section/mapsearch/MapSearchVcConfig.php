...
class MapSearchVcConfig extends AbstractSectionConfig
{
    ...
    public function get_vc_config()
    {
        ...
        return [
            'base' => $name,
            'name' => esc_html__('iHomeFinder MapSearch section', 'realtyspace'),
    ...
    {
        return 'modules/ihomefinder/section/mapsearch.twig';
    }

    protected function create_view(array $data)
    {
        return new MapSearchView($data);
    }
}