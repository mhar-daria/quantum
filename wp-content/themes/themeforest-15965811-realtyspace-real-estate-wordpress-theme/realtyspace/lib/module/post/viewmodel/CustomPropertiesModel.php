...
class CustomPropertiesModel
{
    ...
    protected $eval_key = array(
        'date'  => 'Last_Updated',
        'price' => 'Price',
        'area'  => 'Plot_Area'
    );

    protected $eval_format = array(
        'date'  => 'date',
        'price' => 'number',
        'area'  => 'number'
    );
    ...
    protected function get_options( $properties = array() )
    {
    ...
    protected function get_properties( $properties = array(), $start = 0, $end = 0 ) {
        $datas = array();
    ...
    protected function set_query_params( $options = array() ) {
        $query_params = '';
    ...
    protected function set_uri($options = array())
    {
    ...
    public function get_property_type($ids=null)
    {
        ...
        $term = $this->get_term_by('term_id', $ids, 'cf47rs_property_type');

        return isset($term['name']) ? array($term['name']) : null;
    }
    ...
    public function get_property_location($ids=null)
    {
        ...
        $term = $this->get_term_by('term_id', $ids, 'cf47rs_property_location');
    ...
    public function get_contract_type($ids=array())
    {
        ...
        $term = $this->get_term_by('term_id', $ids, 'cf47rs_property_contract');
